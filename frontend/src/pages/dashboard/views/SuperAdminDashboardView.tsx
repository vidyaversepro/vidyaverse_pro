  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto pb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2"><EnrollmentTrendChart /></div>
        <div className="lg:col-span-1"><RecentActivityFeed /></div>
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2"><InstitutionsOverviewTable /></div>
